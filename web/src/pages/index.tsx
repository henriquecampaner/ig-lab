...
const advantages = [
  {
    name: "Support 1-1",
    description:
      "Ask questions directly with our team of devs ready to save you from that unexpected bug.",
    icon: SupportIcon,
  },
  {
                  ...
                  <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
                    <div className="lg:py-24">
                      ...
                      <h1 className="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                        <span className="block">Training of</span>
                    ...
                    <blockquote>
                      <div>
                        ...
                        <p className="mt-6 text-2xl font-medium text-white">
                          After I started studying on this platform I I managed
                      ...
                      <footer className="mt-6">
                        ...
                        <p className="text-base font-medium text-cyan-100">
                          Software Engineer @ DreamCompany
                        </p>
                      </footer>
                    </blockquote>
                  </div>
